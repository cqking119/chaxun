    ...
    <div data-options="region:'west',title:'菜单',split:true" style="width:230px;">
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
         	<li>
         		<span>非授权账户信息管理</span>
         		<ul>
	         		<li data-options="attributes:{'url':'item-chaxun'}">二级单位资金归集率查询</li>
	         		<li data-options="attributes:{'url':'item-list'}">录入信息修改</li>
	         		<li data-options="attributes:{'url':'item_orcle'}">财务报表导出</li>
	         	</ul>
         	</li>
         	<li>
         		<span>知识库管理系统</span>
